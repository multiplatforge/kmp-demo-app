...
kotlin {
    ...
    // CocoaPods ———————————————————————————————————————————————————————————————————————————————————
    cocoapods {
        summary = "Code shared between the PizzApp Android & iOS apps"
        homepage = "https://multiplatforge.com"
        ios.deploymentTarget = TARGET_IOS_VERSION
        podfile = project.file("../pizzapp-ios-app/Podfile")
        framework {
            baseName = "PizzAppShared"
        }
    }
}
